...
## Your Role: Simple & Straightforward

### Primary Task

**Host a laptop at your location. Provide secure remote access to our team.**

That's it! We handle all technical work remotely.

### Optional: Client Interviews

Represent our team in initial client conversations. Earn bonus income.
Strong communication skills with some experiences of software development concepts.
We will support for your calls.

Prior experience in technical recruitment and Software development experiences will be plus.
...
Your income grows based on your level of involvement. Start with basic hosting and add optional tasks to increase earnings.

### Income Components

- **Laptop Hosting** (10%): Base income for providing hardware access. Completely passive.
- **Account Provision** (+20%): Additional share if you provide your account or a friend's account.
- **Client Management** (+20%): Extra compensation for handling interviews and account administration.
- **Maximum Share** (50%): Total income share when handling all tasks together.

### Partnership Levels

#### Entry Level
Just host the laptop. Earn 10% passive income with zero active work.

#### Mid Involvement
Add account hosting. Boost your share to 30% of project income.

#### Full Partnership
Take on client communication too. Receive 50% of all generated income.
...
> This is a legitimate opportunity to monetize your unused laptop and internet connection. No complicated technical work required.
